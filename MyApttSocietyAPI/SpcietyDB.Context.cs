...
namespace MyApttSocietyAPI
{
    ...
    public partial class NestinDBEntities : DbContext
    {
        public NestinDBEntities()
            : base("name=NestinDBEntities")
        {
        }
        ...
        public virtual DbSet<LatestFlatUser> LatestFlatUsers { get; set; }
        ...
        public virtual DbSet<ViewEmployeeAssignment> ViewEmployeeAssignments { get; set; }
        ...
        public virtual DbSet<ViewFlatsBillPlan> ViewFlatsBillPlans { get; set; }
        ...
        public virtual DbSet<ViewNewFlat> ViewNewFlats { get; set; }
